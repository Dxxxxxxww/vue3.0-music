...
export default {
  ...
  setup() {
    ...
    //     console.log('player--', store.state.wrapperTransform)
    //   }
    //   // else {
    ...
    // function setWrapperTransform(value) {
    //   wrapperTransform.value = value
    //   const cdRefVal = cdRef.value
    //   cdRefVal.style.transform = value
    // }
    // hooks
    // 切换播放模式
